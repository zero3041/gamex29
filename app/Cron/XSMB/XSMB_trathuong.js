...
module.exports = function() {
	let date = new Date();
	date = Helpers.numberPad(date.getDate(), 2) + '/' + Helpers.numberPad(date.getMonth()+1, 2) + '/' + date.getFullYear();
			...
			xsmb_cuoc.find({date:date}, {}, function(errC, cuoc){
				...
				if (cuoc.length > 0) {
					...
					let lo2so = [
						...
						...data.g2.map(function(obj){return obj.substring(obj.length-2)}),
						...data.g3.map(function(obj){return obj.substring(obj.length-2)}),
						...data.g4.map(function(obj){return obj.substring(obj.length-2)}),
						...data.g5.map(function(obj){return obj.substring(obj.length-2)}),
						...data.g6.map(function(obj){return obj.substring(obj.length-2)}),
						...data.g7.map(function(obj){return obj.substring(obj.length-2)})
					];
