	...
	.then(result => {
		Promise.all(result[0].map(function(users, index){
			if (index == 0) {
				...
				UserInfo.findOneAndUpdate({'id': users.uid}, {$inc:{'red':150000}}).exec(function(err, user){
					let date = new Date();
					date.setDate(date.getDate()-1);
					let stringTime = numberPad(date.getDate(), 2) + '/' + numberPad(date.getMonth()+1, 2) + '/' + date.getFullYear();
				...
				UserInfo.findOneAndUpdate({'id': users.uid}, {$inc:{'red':90000}}).exec(function(err, user){
					let date = new Date();
					date.setDate(date.getDate()-1);
					let stringTime = numberPad(date.getDate(), 2) + '/' + numberPad(date.getMonth()+1, 2) + '/' + date.getFullYear();
				...
				UserInfo.findOneAndUpdate({'id': users.uid}, {$inc:{'red':70000}}).exec(function(err, user){
					let date = new Date();
					date.setDate(date.getDate()-1);
					let stringTime = numberPad(date.getDate(), 2) + '/' + numberPad(date.getMonth()+1, 2) + '/' + date.getFullYear();
				...
				// UserInfo.findOneAndUpdate({'id': users.uid}, {$inc:{'red':10000}}).exec(function(err, user){
				// 	let date = new Date();
				// 	date.setDate(date.getDate()-1);
				// 	let stringTime = numberPad(date.getDate(), 2) + '/' + numberPad(date.getMonth()+1, 2) + '/' + date.getFullYear();
		...
		Promise.all(result[1].map(function(usersL, indexL){
			if (indexL == 0) {
				...
				UserInfo.findOneAndUpdate({'id': usersL.uid}, {$inc:{'red':150000}}).exec(function(err, user){
					let date = new Date();
					date.setDate(date.getDate()-1);
					let stringTime = numberPad(date.getDate(), 2) + '/' + numberPad(date.getMonth()+1, 2) + '/' + date.getFullYear();
				...
				UserInfo.findOneAndUpdate({'id': usersL.uid}, {$inc:{'red':90000}}).exec(function(err, user){
					let date = new Date();
					date.setDate(date.getDate()-1);
					let stringTime = numberPad(date.getDate(), 2) + '/' + numberPad(date.getMonth()+1, 2) + '/' + date.getFullYear();
				...
				UserInfo.findOneAndUpdate({'id': usersL.uid}, {$inc:{'red':70000}}).exec(function(err, user){
					let date = new Date();
					date.setDate(date.getDate()-1);
					let stringTime = numberPad(date.getDate(), 2) + '/' + numberPad(date.getMonth()+1, 2) + '/' + date.getFullYear();
