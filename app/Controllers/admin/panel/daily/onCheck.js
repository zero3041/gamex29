                ...
                if (!!usInfo) {
                    if (dl && dl.level == 1) {
                        res.json({
                            ...
                            success: false,
                            data: {
                                nickname: 'Không được chuyển Coin cho cấp 1 khác'
                            }
                        });
                        ...
                        res.json({
                            ...
                            success: false,
                            data: {
                                nickname: 'Không được chuyển Coin cho cấp 2 khác nhánh của bạn'
                            }
                        });
                        ...
                        res.json({
                            ...
                            success: false,
                            data: {
                                nickname: 'Không được chuyển Coin cho chính mình'
                            }
                        });
                    } else {
                        res.json({
