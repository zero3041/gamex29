...
var giftcodeDailyBank = require('./app/Controllers/admin/panel/daily/giftcodeDailyBank');
...
module.exports = function(app, redT) {
    ...
    app.post('/api/v1/admin/giftcodeDailyBank', isAuthenticated, giftcodeDailyBank);
    ...
    app.get('/api/v1/admin/userHistory',isAuthenticated, isAdmin, userHistory);
};
