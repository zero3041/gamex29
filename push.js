...
let TelegramTokenDaiLy = '1751154472:AAHOBvpb7Mc2NgpdL-K1uFux1Vb7-DtRNRQ';
...
mongoose.connect(configDB.url, configDB.options).then(function(){
    ...
    setInterval(function(){
        ...
        Push.findOne({'action':false,type: { $in: ["GameTXBet", "GameXocXocBet","GameBauCuaBet"] }}, {}, {sort:{'_id':-1}, skip:0, limit:1}, function(err, result) {
            if(result){
